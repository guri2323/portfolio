    ...
    <div className="bg-slate-950 text-slate-50">
      <section className="max-w-6xl mx-auto px-4 md:px-8 py-16 space-y-12">
        ...
        <div className="space-y-3 max-w-3xl">
          ...
          <h1 className="text-4xl font-semibold tracking-tight">Timeline of Impact.</h1>
        ...
        <div className="space-y-4">
          <p className="text-xl uppercase text-slate-400 tracking-[0.2em]">Experience Timeline</p>
          <ExperienceTimeline />
        </div>
      </section>
    </div>
